# Fuente: https://cosasdedevs.com/posts/como-crear-un-crud-en-python-parte-2-creacion-y-listado/
...
class Validations:
    ...
    def validateBirthday(self, birthday):
        try:
            ...
            raise ValueError('El formato de la fecha es incorrecta, debe ser DD-MM-YYYY')
        return True